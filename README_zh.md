...
买衣服前先看看上身效果，把随手拍的产品图变成商品展示图，预览新家具放进家里的样子，或让模糊破损的老照片重新清晰起来。这个仓库帮你用 Nano Banana 编辑自己的图片，从日常修图到趣味风格转换，找到想尝试的用途。

通过前后对比图挑选你喜欢的效果，再参考案例中的简短工作流和完整提示词，按自己的图片调整即可开始，不必从零琢磨怎么描述。由 SeeAPI 整理，提供英文与简体中文版本。
...
```text
将上传的图片转换为传统手绘油画。保留原始主体和构图，以厚重而富有表现力的笔触、层层叠加的油彩、细腻的厚涂肌理、可见的画布纹理、丰富的色彩层次，以及具有绘画质感的高光与阴影，重新诠释整张图片。运用柔和的边缘过渡与自然的明暗变化，呈现真实实体画作的质感。细节丰富，富有艺术性，具有经久不衰的纯艺术美感；比例写实，色彩和谐，呈现画廊级油画品质。
```
